...
export const SECTIONS: Section[] = [
  ...
  { id: "skin", title: "Peau & exposition solaire", fields: [
    ...
    { id: "sunHoursWeek", label: "Heures de soleil / semaine", type: "number", suffix: "h", col: 1 },
    { id: "sunscreenUse", label: "Crème solaire", type: "frequency" },
    { id: "severeBurns", label: "Coups de soleil sévères dans la vie", type: "number", col: 1 },
  ...
  { id: "recovery", title: "Récupération & exposition thermique", fields: [
    ...
    { id: "saunaDurationMin", label: "Durée moyenne (min)", type: "number", suffix: "min", col: 1 },
    ...
    { id: "balanceFalls", label: "Chutes dans les 12 derniers mois", type: "number", col: 1 },
  ]},

  { id: "substances", title: "Substances détaillées", fields: [
    { id: "tobaccoPackYears", label: "Tabac — pack-years (paquets/jour × années)", type: "number", col: 1 },
    { id: "alcoholBingeWeek", label: "Épisodes binge (4+ verres) / semaine", type: "number", col: 1 },
    ...
    { id: "caffeineLastTime", label: "Heure de la dernière caféine habituelle", type: "text", col: 1, placeholder: "ex: 14h00" },
  ]},

  { id: "socialWork", title: "Travail & vie sociale", fields: [
    { id: "occupationDetail", label: "Métier", type: "text", col: 2 },
    { id: "remoteWorkPct", label: "% télétravail", type: "number", suffix: "%", col: 1 },
    { id: "workStressLevel", label: "Stress professionnel", type: "scale10", minLabel: "Aucun", maxLabel: "Maximal" },
    { id: "workHoursWeek", label: "Heures de travail / semaine", type: "number", suffix: "h", col: 1 },

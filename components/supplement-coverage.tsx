...
import { Gauge, AlertTriangle, Check, ArrowUp, ArrowDown, Activity } from "lucide-react";
      ...
      <header className="flex items-start justify-between mb-4 flex-wrap gap-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1 max-w-2xl leading-relaxed">
            Pour chaque nutriment, on calcule l'apport quotidien total (somme des suppléments) et on le compare à la cible optimale.
            La barre montre où tu es : <span className="text-amber-400">sous la cible</span> · <span className="text-emerald">cible optimale</span> · <span className="text-sky-400">au-dessus</span> · <span className="text-red-400">plafond</span>.
          </p>
        </div>

...
// ───────────────────────────────────────────────────────────────
// Categories MUST match the CATS list in app/(app)/dna/page.tsx:
// cardiovascular, metabolism, longevity, nutrition, fitness, cognitive,
// hormones, immunity, detox, carriers.
const dnaInsights = [
  ...
  ["rs1042522", "longevity", "TP53 codon 72", "Réparation ADN, stress cellulaire", 2.0, "G", "GG", 0, 1, "Pro/Pro: meilleure réparation ADN."],
  ["rs1801131", "nutrition", "MTHFR A1298C", "Réduit conversion folate", 2.5, "G", "GG", 0, 1, "Pas de mutation A1298C — méthylation folate optimale."],
  ["rs1801133", "nutrition", "MTHFR C677T", "Réduit conversion folate", 3.0, "T", "CT", 1, 0, "Hétérozygote: efficacité MTHFR ~65%. Privilégier 5-MTHF + B12 méthylée."],
  ["rs762551", "nutrition", "CYP1A2 caféine", "Métabolisme caféine", 2.0, "A", "AA", 0, 1, "Métaboliseur rapide — bien toléré, mais pas après 14h."],
  ["rs4988235", "nutrition", "LCT lactase persistance", "Tolérance lactose", 3.0, "A", "AA", 0, 1, "Lactase persistante. Lactose toléré toute la vie."],
  ["rs2228570", "nutrition", "VDR FokI vitamine D", "Sensibilité vitamine D", 2.5, "A", "AA", 0, 0, "Variante FF: réponse vitamine D plus faible — supplémentation à dose haute."],
  ["rs7041", "nutrition", "GC vitamine D binding", "Transport vit D", 2.0, "G", "GT", 0, 0, "Hétérozygote: transport vit D standard."],
  ["rs602662", "nutrition", "FUT2 (microbiote)", "Diversité microbiote", 1.5, "A", "GG", 0, 0, "Sécréteur normal."],
  ["rs4680", "cognitive", "COMT Val158Met", "Dopamine cortex préfrontal", 2.5, "A", "AA", 0, 1, "Met/Met: profil 'warrior' — dopamine forte sous stress."],
  ["rs6265", "cognitive", "BDNF Val66Met", "Plasticité neuronale", 2.5, "A", "GG", 0, 1, "Val/Val: plasticité neuronale optimale."],
  ["rs1800497", "cognitive", "DRD2 Taq1A", "Sensibilité dopamine", 2.0, "A", "GG", 0, 1, "Récompense dopamine normale."],
  ["rs53576", "cognitive", "OXTR (empathie/social)", "Lien social, empathie", 1.5, "G", "AG", 0, 0, "Hétérozygote — empathie standard."],
  ["rs9939609", "metabolism", "FTO", "Risque surpoids", 1.5, "A", "AT", 0, 0, "Hétérozygote: faible tendance accumulation graisse abdominale."],
  ["rs1421085", "metabolism", "FTO leptin", "Signal satiété", 2.0, "C", "TT", 0, 1, "Pas porteur. Régulation appétit normale."],
  ["rs1799945", "metabolism", "HFE H63D", "Surcharge fer modérée", 2.5, "G", "CG", 1, 0, "Hétérozygote H63D — surveiller ferritine régulièrement."],
  ["rs1800562", "metabolism", "HFE C282Y", "Hémochromatose", 3.5, "A", "GG", 0, 1, "Pas porteur C282Y."],
  ["rs7903146", "metabolism", "TCF7L2 (diabète T2)", "Risque diabète T2", 3.5, "T", "CT", 1, 0, "Hétérozygote — risque T2 +30%. Surveiller HbA1c."],
  ["rs17782313", "metabolism", "MC4R (faim)", "Augmente faim", 1.5, "C", "TT", 0, 1, "Pas porteur. Satiété normale."],
  ["rs1057910", "metabolism", "CYP2C9*3 (warfarine)", "Métabolisme warfarine", 2.5, "C", "AA", 0, 1, "Métaboliseur normal."],
  ["rs4244285", "metabolism", "CYP2C19*2 (clopidogrel)", "Métaboliseur lent", 2.5, "A", "GG", 0, 1, "Métaboliseur normal."],
  ["rs1815739", "fitness", "ACTN3", "Endurance vs puissance", 2.0, "T", "CC", 0, 1, "Performance polyvalente."],
  ...
  ["rs700518", "hormones", "CYP19A1 aromatase", "Conversion testo→œstro", 1.5, "G", "GG", 0, 0, "Aromatase neutre."],
  ["rs225014", "hormones", "DIO2 conversion T4→T3", "Activité thyroïdienne", 2.5, "C", "TT", 0, 1, "Conversion T4→T3 optimale."],
  ["rs1799752", "immunity", "ACE I/D", "Rénine-angiotensine", 2.0, "D", "II", 0, 1, "I/I — meilleure endurance, inflammation moindre."],
  ["rs2476601", "immunity", "PTPN22 auto-immunité", "Risque auto-immun", 3.0, "A", "GG", 0, 1, "Pas porteur — risque auto-immun faible."],
  ["rs231775", "immunity", "CTLA4 T-cell", "Auto-immunité thyroïdienne", 2.0, "G", "AA", 0, 1, "Régulation lymphocytaire normale."],
  ["rs1695", "detox", "GSTP1 glutathione", "Détox xénobiotiques", 2.0, "G", "AG", 0, 0, "Hétérozygote — phase II ~70% efficacité."],
  ["rs1799853", "detox", "CYP2C9 phase I", "Métabolisme médicaments", 2.0, "T", "CC", 0, 1, "Phase I optimale."],
  ["rs1056836", "detox", "CYP1B1 hormones+toxines", "Métabolisme œstrogènes", 2.5, "G", "CG", 0, 0, "Hétérozygote — moyen."],
  ["rs1815739_carrier", "carriers", "SMA carrier (SMN1)", "Mutation récessive transmissible", 2.0, "del", "+/-", 1, 0, "Hétérozygote porteur SMA. Pas un risque pour toi. Pertinent pour la planification familiale uniquement."],
];

  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 space-y-6">
        ...
        <section className="space-y-3"><h2 className="text-xl font-semibold tracking-tight mt-8">3. Utilisation Anthropic Claude</h2><p className="text-sm leading-relaxed">Les requêtes au panel médical envoient des extraits ciblés de tes données à l&apos;API Anthropic (Claude Sonnet 4.5). Anthropic ne stocke pas ces requêtes pour entraînement (politique commerciale). Mode &quot;Anonymisation LLM&quot; activable.</p></section>

...
const ALIASES: Record<string, { canonical: string; category: string; unit?: string }> = {
  ...
  "acide cis vaccenique": { canonical: "Acide cis-vaccénique", category: "fatty-acids", unit: "%" },
  "acide trans vaccenique": { canonical: "Acide trans-vaccénique", category: "fatty-acids", unit: "%" },
  "acide trans palmitoleique": { canonical: "Acide trans-palmitoléique", category: "fatty-acids", unit: "%" },
  "acide elaidique": { canonical: "Acide élaïdique (trans)", category: "fatty-acids", unit: "%" },
  "acide rumenique": { canonical: "Acide ruménique", category: "fatty-acids", unit: "%" },
  "acide eicosatrienoique": { canonical: "Acide eicosatriénoïque", category: "fatty-acids", unit: "%" },
  ...
  // Electrolyte + Lp(a) — alias keys MUST be in normalised form (parens are
  // stripped to nothing by lookupBiomarker, so "lp(a)" as a key is unreachable).
  "chlore": { canonical: "Chlore", category: "minerals", unit: "mmol/L" },
  "chlore serique": { canonical: "Chlore", category: "minerals", unit: "mmol/L" },
  "lpa": { canonical: "Lp(a)", category: "lipids", unit: "mg/dL" },
  "lipoproteine lpa": { canonical: "Lp(a)", category: "lipids", unit: "mg/dL" },
